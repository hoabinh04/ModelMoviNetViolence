        ...
        if len(boxes) > 0:
            ...
            if active_tube_center is not None and tube_life > 0:
                ...
                if crop_img.size != 0:
                    if frame_idx % 10 == 0:
                        import os
                        debug_dir = r"C:\Users\Lenovo\.gemini\antigravity\brain\ba37f367-9edb-4135-9329-6c370b54077e\artifacts\debug_roi"
                ...
                cv2.rectangle(vis_frame, (x1_u, y1_u), (x2_u, y2_u), (0, 255, 255), 2)
                cv2.putText(
                    vis_frame,
                    "Target Lock-on",
                    (x1_u, max(20, y1_u - 8)),
