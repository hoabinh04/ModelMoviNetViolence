...
MIN_TUBE_SIZE = 180
MAX_TUBE_SIZE = 1080
ROI_EXPAND_RATIO = 2.2 # Tăng mở rộng để bắt trọn tay chân
ROI_SIZE_SMOOTH = 0.4
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tsm-variant", choices=["small", "large"], default="large", help="Architecture variant (small or large)")
...
def main() -> None:
    ...
    tsm_model = MobileNetV3_TSM(num_classes=2, num_segments=args.num_segments, pretrained=False, variant=args.tsm_variant)
